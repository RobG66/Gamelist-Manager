    ...
    public static class GamelistMetaData
    {
        ...
        static GamelistMetaData()
        {
            var gameDecls = new List<MetaDataDecl>
            {
                ...
                new MetaDataDecl { Key = MetaDataKeys.lang, Type = "lang", Name = "Language", DataType = MetaDataType.String, Scrapers = new List<string>{ "ScreenScraper", "ArcadeDB" }, Viewable = true, editible = true },
                new MetaDataDecl { Key = MetaDataKeys.region, Type = "region", Name = "Region", DataType = MetaDataType.String, Scrapers = new List<string>{ "ScreenScraper", "ArcadeDB" }, Viewable = true, editible = true },
                ...
                new MetaDataDecl { Key = MetaDataKeys.wheel, Type = "wheel", Name = "Wheel", DataType = MetaDataType.Image, Scrapers = new List<string>{ "ArcadeDB", "ScreenScraper", "EmuMovies"}, Viewable = true, editible = false },
                ...
                new MetaDataDecl { Key = MetaDataKeys.arcadesystemname, Type = "arcadesystemname", Name = "Arcade System Name", DataType = MetaDataType.String, Scrapers = new List<string>{ "ScreenScraper" }, Viewable = true, editible = true },
