...
#pragma warning restore IDE1006 // Naming Styles
    ...
    public class MetaDataDecl
    {
        ...
        public bool EsSupported { get; init; } = true;
        public bool EsDeSupported { get; init; } = true;
    ...
    public static class GamelistMetaData
    {
        ...
        static GamelistMetaData()
        {
            var gameDecls = new List<MetaDataDecl>
            {
                ...
                new() { Key = MetaDataKeys.id,                 Type = "id",                 Name = "Game Id",               PropertyName = nameof(GameMetadataRow.Id),                 DataType = MetaDataType.String, Viewable = true,                        Editable = true,  EsDeSupported = false },
                ...
                new() { Key = MetaDataKeys.sortname,           Type = "sortname",           Name = "Sort Name",             PropertyName = nameof(GameMetadataRow.Sortname),           DataType = MetaDataType.String, Viewable = true,                        Editable = true,  EsSupported = false },
                new() { Key = MetaDataKeys.collectionsortname, Type = "collectionsortname", Name = "Collection Sort Name",  PropertyName = nameof(GameMetadataRow.Collectionsortname), DataType = MetaDataType.String, Viewable = true,                        Editable = true,  EsSupported = false },
                ...
                new() { Key = MetaDataKeys.lang,               Type = "lang",               Name = "Language",              PropertyName = nameof(GameMetadataRow.Lang),               DataType = MetaDataType.String, Viewable = true,                        Editable = true,  EsDeSupported = false },
                new() { Key = MetaDataKeys.region,             Type = "region",             Name = "Region",                PropertyName = nameof(GameMetadataRow.Region),             DataType = MetaDataType.String, Viewable = true,                        Editable = true,  EsDeSupported = false },
                ...
                new() { Key = MetaDataKeys.completed,          Type = "completed",          Name = "Completed",             PropertyName = nameof(GameMetadataRow.Completed),          DataType = MetaDataType.Bool,   Viewable = true,                        Editable = true,  EsSupported = false },
                new() { Key = MetaDataKeys.broken,             Type = "broken",             Name = "Broken",                PropertyName = nameof(GameMetadataRow.Broken),             DataType = MetaDataType.Bool,   Viewable = true,                        Editable = true,  EsSupported = false },
                new() { Key = MetaDataKeys.nogamecount,        Type = "nogamecount",        Name = "No Game Count",         PropertyName = nameof(GameMetadataRow.Nogamecount),        DataType = MetaDataType.Bool,   Viewable = true,                        Editable = true,  EsSupported = false },
                new() { Key = MetaDataKeys.nomultiscrape,      Type = "nomultiscrape",      Name = "No Multi-Scrape",       PropertyName = nameof(GameMetadataRow.Nomultiscrape),      DataType = MetaDataType.Bool,   Viewable = true,                        Editable = true,  EsSupported = false },
                new() { Key = MetaDataKeys.hidemetadata,       Type = "hidemetadata",       Name = "Hide Metadata",         PropertyName = nameof(GameMetadataRow.Hidemetadata),       DataType = MetaDataType.Bool,   Viewable = true,                        Editable = true,  EsSupported = false },
                ...
                new() { Key = MetaDataKeys.gametime,           Type = "gametime",           Name = "Game Time",             PropertyName = nameof(GameMetadataRow.Gametime),           DataType = MetaDataType.String, Viewable = true,                        Editable = false, EsDeSupported = false },
                new() { Key = MetaDataKeys.playtime,           Type = "playtime",           Name = "Play Time",             PropertyName = nameof(GameMetadataRow.Playtime),           DataType = MetaDataType.String, Viewable = true,                        Editable = false, EsSupported = false },
                ...
                new() { Key = MetaDataKeys.controller,         Type = "controller",         Name = "Controller",            PropertyName = nameof(GameMetadataRow.Controller),         DataType = MetaDataType.String, Viewable = true,                        Editable = true,  EsSupported = false },
                new() { Key = MetaDataKeys.altemulator,        Type = "altemulator",        Name = "Alt Emulator",          PropertyName = nameof(GameMetadataRow.Altemulator),        DataType = MetaDataType.String, Viewable = true,                        Editable = true,  EsSupported = false },
                new() { Key = MetaDataKeys.folderlink,         Type = "folderlink",         Name = "Folder Link",           PropertyName = nameof(GameMetadataRow.Folderlink),         DataType = MetaDataType.String, Viewable = true,                        Editable = false, EsSupported = false },
                new() { Key = MetaDataKeys.family,             Type = "family",             Name = "Family",                PropertyName = nameof(GameMetadataRow.Family),             DataType = MetaDataType.String, Viewable = true,                        Editable = true,  EsDeSupported = false },
                new() { Key = MetaDataKeys.arcadesystemname,   Type = "arcadesystemname",   Name = "Arcade System Name",    PropertyName = nameof(GameMetadataRow.Arcadesystemname),   DataType = MetaDataType.String, Viewable = true,                        Editable = true,  EsDeSupported = false },
            };
        ...
        {
            return SessionState.Instance.ProfileType == SettingKeys.ProfileTypeEsDe
                ? columnDeclarationsCache.Where(d => d.EsDeSupported).ToList()
                : columnDeclarationsCache.Where(d => d.EsSupported).ToList();
        }

        public static IReadOnlyList<MetaDataDecl> GetToggleableColumns()
        {
            return SessionState.Instance.ProfileType == SettingKeys.ProfileTypeEsDe
                ? toggleableColumnCache.Where(d => d.EsDeSupported).ToList()
                : toggleableColumnCache.Where(d => d.EsSupported).ToList();
        }
